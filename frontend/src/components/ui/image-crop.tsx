...
export const ImageCropContent = ({
  ...
  return (
    <ReactCrop
      className={cn("max-h-[350px] max-w-full", className)}
      crop={crop}
...
export type ImageCropApplyProps = React.ComponentProps<typeof Button>
...
export const ImageCropApply = ({
  ...
  return (
    <Button onClick={handleClick} size={size} variant={variant} {...props}>
      {children ?? <CropIcon className="size-4" />}
    </Button>
  )
}

export type ImageCropResetProps = React.ComponentProps<typeof Button>
